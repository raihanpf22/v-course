...
<head>
    ...
    <title>Table Student | V-Course</title>
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $item->mahasiswa_npm}}</td>
                                            <td>{{ $item->mahasiswa_kelas}}</td>
                                            <td class="col-2">
                                                <a href="{{ route('kursus-edit', $item->mahasiswa_id) }}" class="btn btn-warning btn-sm mb-2">Edit</a>
                                                <form action = "{{route('kursus-destroy',$item->mahasiswa_id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
