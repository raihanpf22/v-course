            ...
            <div class="card-body p-5">
              ...
              <form action="{{ route('kursus-store') }}" method="POST">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="kursus_nama" name="kursus_nama" class="form-control form-control-lg" />
                  <label class="form-label" for="kursus_nama">Course Name</label>
                </div>

                <div class="form-outline mb-4">
                  <textarea type="text" id="kursus_keterangan" name ="kursus_keterangan" class="form-control form-control-lg" ></textarea>
                  <label class="form-label" for="kursus_keterangan">Description</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="text" id="kursus_durasi" name="kursus_durasi" class="form-control form-control-lg" />
