...
<head>
    ...
    <title>Dashboard Admin | V-Course</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">V-Course Admin</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Data Verification</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Data Schedule Course</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth()->guard('admin')->user()->admin_email}}</span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Halo, {{ auth()->guard('admin')->user()->admin_nama }}</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Tables Course</h6>
                            <br>
                            <a href="{{ route('kursus-create')}}" class="btn btn-success">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{ $item->kursus_nama }}</td>
                                            <td>{{ $item->kursus_keterangan}}</td>
                                            <td>{{ $item->kursus_durasi}}</td>
                                            <td class="col-2">
                                                <a href="{{ route('kursus-edit', $item->kursus_id) }}" class="btn btn-warning btn-sm mb-2">Edit</a>
                                                <form action = "{{route('kursus-destroy',$item->kursus_id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
